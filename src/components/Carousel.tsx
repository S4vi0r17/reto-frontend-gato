    ...
    <div className="relative w-full h-[400px] md:h-[500px] overflow-hidden group">
      ...
      >
        <div className="container mx-auto max-w-5xl">
          <h3 className="mb-2 text-3xl font-bold md:text-4xl text-primary">
            {movie.title}
          </h3>
          ...
          {movieGenres.length > 0 && (
            <div className="flex flex-wrap gap-2 mb-4">
              {movieGenres.map((genre) => (
                <span
                  key={genre}
                  className="px-3 py-1 text-sm rounded-full bg-secondary/80 text-secondary-foreground backdrop-blur-sm"
                >
                  {genre}
                </span>
              ))}
